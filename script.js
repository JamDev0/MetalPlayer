...
function AumentarDiminuir()
{
    if(c1 == 0)
    {
        ...
        if(window.innerWidth < 800)
        {
            ...
            document.getElementById('Volume').style.top = '90.6%';
            console.log('AA');
    ...
    else
    {
        ...
        else
        {
            ...
            if(window.innerWidth < 500)
            {
                ...
                AD.style.top = '82.5%';
                range2.style.top = '73%';
                document.getElementById('Audio').style.top = '82%';
                document.getElementById('Audio1').style.top = '84.5%';
                document.getElementById('Audio2').style.top = '83.5%';
                document.getElementById('Audio3').style.top = '82.8%';
                document.getElementById('Volume').style.top = '86%';
            }
            else
            {
                TempoA.style.top = '84.8%';
